...
class Vibrations:
    ...
    def __init__(self,
        ...
        if model == 'marcus':
            self.model_function =  self.get_marcus_vib_spectrum
        elif model == 'levich_jortner':
            self.model_function =  self.get_levich_jortner_vib_spectrum
        elif model == 'empirical':
            self.model_function =  self.get_empirical_vib_spectrum
        elif model == 'gaussian':
            self.model_function = self.get_gaussian_vib_spectrum
        else:
    ...
    def get_vib_spectrum(self, transition, temperature=300):
        return self.model_function(transition, temperature)
        # return self.get_marcus_vib_spectrum(transition, temperature)

    def get_marcus_vib_spectrum(self, transition, temperature=300):
    ...
    def get_levich_jortner_vib_spectrum(self, transition, temperature=300):
    ...
    def get_empirical_vib_spectrum(self, transition, temperature=None):
        # Temperature is not actually used. This is to keep common interface
        return self.empirical_function[transition]

    def get_gaussian_vib_spectrum(self, transition, temperature=300):
        ...
        deviation = self.sigma     # atomic units
